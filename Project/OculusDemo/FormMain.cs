...
namespace OculusDemo
{
    ...
    */
    ...
    public partial class FormMain : Form
    {
        ...
        /// <returns></returns>
        unsafe ControllerReport ParseControllerInputReport(byte[] aInputReport)
        {
        ...
        unsafe bool UpdateControllerState(ref ControllerState ctrl, ControllerReport aReport)
        {
...
//            ctrl->log_flags = report->flags;
        ...
        unsafe public void OnHidEvent(object aSender, SharpLib.Hid.Event aHidEvent)
        {
            ...
            ControllerReport report = ParseControllerInputReport(aHidEvent.InputReport);
            ...
            if (report.device_id!=0)
            {
                ...
                UpdateControllerState(ref state,report);
